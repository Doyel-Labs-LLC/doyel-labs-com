...
export function WebsiteSteadfastFrame() {
  return (
    <figure className="not-prose min-w-0 max-w-full">
      <div className="overflow-hidden border border-line bg-surface">
        ...
        <div className="flex items-center gap-2 border-b border-line px-4 py-2.5">
          ...
          <span className="h-2.5 w-2.5 rounded-full bg-line2" />
          <span className="h-2.5 w-2.5 rounded-full bg-line2" />
          <span className="ml-3 min-w-0 flex-1 truncate rounded-full border border-line px-3 py-1 font-mono text-[11px] text-mute">
